...
Unzip `tmfus-tmf-team-v28.zip` and give Claude the whole folder. Not just one
...
- assets are at `?v=28` and the version must be bumped on every CSS/JS change
...
| `SETUP-CHAT.md` | Live chat and the agent behind it |
